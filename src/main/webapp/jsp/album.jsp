...
<script type="text/javascript">
    $(function () {
        $("#albumTable").jqGrid(
            {
                url : '${pageContext.request.contextPath}/album/queryByPageAlbum',
                datatype : "json",
                height : 500,
                ...
                colModel : [
                    ...
                    {name : 'cover',align:"center",formatter:function (data) {
                            return "<img style='height: 80px;width: 180px' src='"+"${pageContext.request.contextPath}"+data+"'>";
    ...
    function addSubgrid(subgrid_id,row_id){
        ...
        $("#" + subgrid_table_id).jqGrid(
            {
                url : "${pageContext.request.contextPath}/chapter/queryBypageChapter?albumId="+row_id,
                datatype : "json",
                ...
                styleUI:"Bootstrap",
                autowidth: true,
                editurl: '${pageContext.request.contextPath}/chapter/save?albumId='+row_id
            });
